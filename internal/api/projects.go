...
func (s *Server) ListProjects(ctx context.Context, request ListProjectsRequestObject) (ListProjectsResponseObject, error) {
	...
	if herr != nil {
		return nil, herr
	} else if err := s.checkOrgAuthorization(ctx, uid, request.OrgId, PermissionProjectRead); err != nil {
		return nil, err
	}
...
func (s *Server) CreateProject(ctx context.Context, request CreateProjectRequestObject) (CreateProjectResponseObject, error) {
	...
	if herr != nil {
		return nil, herr
	} else if err := s.checkOrgAuthorization(ctx, uid, request.OrgId, PermissionProjectWrite); err != nil {
		return nil, err
	}
...
func (s *Server) UpdateProject(ctx context.Context, request UpdateProjectRequestObject) (UpdateProjectResponseObject, error) {
	...
	if herr != nil {
		return nil, herr
	} else if err := s.checkProjectAuthorization(ctx, uid, request.OrgId, request.ProjectId, PermissionProjectWrite); err != nil {
		return nil, err
	}
